        ...
        function (e, n, r) {
          ...
          var o = {
            ...
            easeOutExpo: function (i, a, s, l) {
              var u = s - a;
              return i == l ? a + u : u * (1 - Math.pow(2, (-10 * i) / l)) + a;
            },
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            return (N =
              ...
              function (P) {
                for (var T = 1; T < arguments.length; T++) {
                  var k = arguments[T];
                  for (var C in k)
                    Object.prototype.hasOwnProperty.call(k, C) && (P[C] = k[C]);
                }
                return P;
          ...
          function X(P) {
            for (var T = 1; T < arguments.length; T++) {
              var k = arguments[T] != null ? arguments[T] : {};
              T % 2
                ? B(Object(k), !0).forEach(function (C) {
                    Mt(P, C, k[C]);
                  })
                : Object.getOwnPropertyDescriptors
                ? Object.defineProperties(
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
          ...
          var z = s.a.forwardRef(function (P, T) {
  ...
  gt();
  yt();
  var US = __STORYBOOKCOREEVENTS__,
    {
      CHANNEL_CREATED: HS,
      CONFIG_ERROR: WS,
      ...
      STORY_UNCHANGED: SP,
      TOGGLE_WHATS_NEW_NOTIFICATIONS: PP,
      UPDATE_GLOBALS: TP,
      UPDATE_QUERY_PARAMS: CP,
      UPDATE_STORY_ARGS: ou,
    } = __STORYBOOKCOREEVENTS__;
  vt();
  gt();
  yt();
  var DP = __STORYBOOKCOMPONENTS__,
    {
      A: NP,
      ActionBar: IP,
      AddonPanel: LP,
  ...
  var XT = __STORYBOOKAPI__,
    {
      ...
      Provider: JT,
      addons: Ni,
      combineParameters: ZT,
      controlOrMetaKey: $T,
      controlOrMetaSymbol: tC,
      ...
      merge: aC,
      mockChannel: sC,
      optionOrAltSymbol: lC,
      shortcutMatchesShortcut: uC,
      shortcutToHumanString: cC,
      types: pC,
      useAddonState: fC,
      useArgTypes: dC,
      useArgs: hC,
  ...
  var xy = Object.create,
    ...
    v = (t, e) => () => (t && (e = t((t = 0))), e),
    ee = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports),
    gf = (t, e) => {
  ...
  var mu,
    ...
    Jy = ee((t) => {
      ...
      var e =
        ...
        n = "The error message is optional, but must be a string if provided.",
        r = function (l, u, c, f) {
              ...
              },
              {
                ...
                value: function (r, o) {
                  if (de) {
                    ...
                    var Nt = D(D({}, this.state), {}, { index: l, step: ht }),
                      Wt = et("action", [tt.NEXT, tt.PREV, tt.SKIP, tt.CLOSE]);
      ...
      Vn(),
        ...
        (Pd = ct((t, e) => {
          ...
          let {
            ...
            S = Ob((N) => {
              let B = N.target,
                X = [...c.branches].some((et) => et.contains(B));
        ...
        (Cd = ct((t, e) => {
          ...
          let h = xt(
            (m) => {
              ...
              let y = m.key === "Tab" && !m.altKey && !m.ctrlKey && !m.metaKey,
...
`;
  ...
  function Gw(t, e, n) {
    let r = n;
    for (let o = 1; o < zm; o++) r = r - t(r) / e(r);
    return r;
  }
  function ts(t, e) {
  ...
  function av(t) {
    ...
    let B = N(Object.assign(Object.assign({}, m), { from: r, to: y }));
    function X() {
      x++,
        l === "reverse"
        ...
        var p,
          ...
          b = function (M) {
            ...
            if (
              ...
              return "continue";
            var Tt = px(B.prevProp, X),
              Ct = Tt || (N === f && B.isActive && !ht && et) || (M > x && et),
              Ft = Array.isArray(X) ? X : [X],
              St = Ft.reduce(i, {});
            rt === !1 && (St = {});
            var Nt = B.prevResolvedValues,
              Wt = Nt === void 0 ? {} : Nt,
              ne = A(A({}, Wt), St),
              Mt = function (z) {
              ...
              Ct &&
                ...
                m.push.apply(
                  ...
                  $t(
                    ...
                    bt(
                      Ft.map(function (z) {
                        return { animation: z, options: A({ type: N }, c) };
                      })
                    ),
                    !1
                  )
        ...
        (eg = (function () {
          ...
          return (
            ...
            (t.prototype.resolveRefConstraints = function () {
              ...
              var a = Cx(o, i.root, this.visualElement.getTransformPagePoint()),
      ...
      G(),
        ...
        (Hl = function (t) {
          ...
          return function (p, d) {
            ...
            function St(I, z) {
              var P = z.onChange(function (k) {
                  (O[I] = k), m.onUpdate && te.update(Ft, !1, !0);
                }),
                T = z.onRenderRequest(Z.scheduleRender);
              X.set(I, function () {
                P(), T();
              });
            }
              ...
              Z = A(
                A(
                  {
                    ...
                    makeTargetAnimatable: function (I, z) {
                      return z === void 0 && (z = !0), i(Z, I, m, z);
                    },
                    measureViewportBox: function () {
                      return a(M, m);
                    },
                    addValue: function (I, z) {
                    ...
                    getValue: function (I, z) {
                      var P = B.get(I);
                      return (
                        P === void 0 &&
                          z !== void 0 &&
                          ((P = jn(z)), Z.addValue(I, P)),
                        P
                      );
                    },
                    ...
                    readValue: function (I) {
                      var z;
                      return (z = O[I]) !== null && z !== void 0
                        ? z
                        : l(M, I, d);
                    },
                    setBaseTarget: function (I, z) {
                      rt[I] = z;
                    },
                ...
                ),
                {
                  ...
                  getVariant: function (I) {
                    var z;
                    return (z = m.variants) === null || z === void 0
                      ? void 0
                      : z[I];
                  },
        ...
        (fg = Hl(
          A(A({}, bs), {
            ...
            readValueFromInstance: function (t, e) {
              var n;
              return zr(e)
                ? ((n = gi(e)) === null || n === void 0 ? void 0 : n.default) ||
                    0
              ...
              this.options.animate !== !1 &&
                ...
                this.addEventListener("didUpdate", function (E) {
                  ...
                  var et =
                    ...
                    Ct = !u.targetLayout || !Og(u.targetLayout, X) || B,
                    Ft = !N && B;
                  if (
                    ...
                    h.shouldReduceMotion && ((St.delay = 0), (St.type = !1)),
                      u.startAnimation(St);
                  } else !N && u.animationProgress === 0 && u.finishAnimation(), u.isLead() && ((S = (O = u.options).onExitComplete) === null || S === void 0 || S.call(O));
                  u.targetLayout = X;
                });
          }
        }),
          ...
          for (var S in Ar)
            if (x[S] !== void 0) {
              var M = Ar[S],
                ...
                X = N(x[S], y);
              if (B)
                for (var et = B.length, rt = 0; rt < et; rt++) h[B[rt]] = X;
              else h[S] = X;
            }
          return (
            this.options.layoutId &&
